    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" action="{{ route('aap_raffles.store') }}" enctype="multipart/form-data">
                ...
                <input type="hidden" name="ar_attendees" value="0">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="ar_order" value="1">
                    </div>
...
function setNextOrderNumber(tableId) {
    ...
    document.querySelector('#attendeesRaffleModal input[name="ar_order"]').value = nextOrder;
}
</script>